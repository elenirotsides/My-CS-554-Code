...
store.subscribe(() => {
    //this State change listener will be called EVERY time an action is dispatched
    console.log('State Changed', store.getState()); //store.getState() exposes the state (object)
});
